...
public class SnackCashierDashboard extends javax.swing.JFrame {
    ...
    private void hint() {
        ...
        if (jTextField4 != null) {
            jTextField4.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Qty");
        }
        if (jTextField6 != null) {
            jTextField6.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Avalible Qty");
        }
        if (jTextField7 != null) {
            jTextField7.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Price");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        StockGRN sg = new StockGRN(this, true);
        sg.setVisible(true);
