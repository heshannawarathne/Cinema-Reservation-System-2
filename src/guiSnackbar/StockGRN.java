 ...
 */
public class StockGRN extends javax.swing.JDialog {

    private SnackCashierDashboard invoice;

    public void setinvoice(SnackCashierDashboard invoice) {
        this.invoice = invoice;
    }

    public StockGRN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadGRNItem("");
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            String product_id = String.valueOf(jTable2.getValueAt(row, 1));
            String Name = String.valueOf(jTable2.getValueAt(row, 2));
            ...
            invoice.getjTextField3().setText(stock_id);
            invoice.getjTextField2().setText(product_id);
            invoice.getjTextField4().setText(qty);
            invoice.getjTextField7().setText(selling_price);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockGRN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StockGRN dialog = new StockGRN(new javax.swing.JFrame(), true);
